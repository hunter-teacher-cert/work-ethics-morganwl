...
# def write_html(selects, html_file):
#     """Writes an html file containing all selected documents."""
#     with open(html_file, 'w') as html_object:
#         html_object.write('<html><body>\n')
#         for key, weat in selects.items():
#             html_object.write('<h2>{}</h2>\n'.format(key))
#             for df in weat:
#                 html_object.write('<table>\n')
#                 html_object.write(format_table_row(df.columns))
#                 for index, row in df.iterrows():
#                     html_object.write(format_table_row(
#                         value for col, value in row.iteritems()))
#                 html_object.write('</table>\n')
#         html_object.write('</body></html>')
